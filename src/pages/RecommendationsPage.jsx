...
function demoRecommendation(context) {
  ...
  return {
    ...
    meals,
    assumptions: ['This is a local demo result and was not generated by OpenAI.'],
...
function recommendationError(error) {
  if (error.code === 'openai_key_required') {
    return 'Add your OpenAI API key in Account before requesting recommendations.'
  }
  ...
  return error.message || 'Could not generate meal recommendations.'
}
...
function RecommendationsPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (!handleUnauthorized(requestError)) setError(recommendationError(requestError))
    } finally {
      setRequesting(false)
    }
  }
